...
- [Communication Protocol Setup](./communication-protocol-setup/) - Set up how an AI assistant communicates with its user through interactive Q&A (12 rules + 3 red lines), instead of a static doc.
